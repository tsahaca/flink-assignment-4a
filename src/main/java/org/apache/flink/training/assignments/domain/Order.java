...
public class Order extends IncomingEvent {
    ...
    public static class OrderBuilder {
        ...
        public String toString() {
            return "Order.OrderBuilder(orderId=" + this.orderId
                    + ", cusip=" + this.cusip + ", assetType=" + this.assetType +
                    ", buySell=" + this.buySell + ", bidOffer=" + this.bidOffer +
                    ", currency=" + this.currency + ", quantity=" + this.quantity +
                    ", orderTime=" + this.orderTime + ", allocations=" + this.allocations + ")";
